...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Database Error Mode', 'DB_ERROR_MODE', 'friendly', 'Change what will be displayed when database errors occur.<p>\'Silent reporting\' sends you emails about the error(s).<p><font color="red"><b>debug</b> shows sensitive information and is not recommended on live shops</font>', 16, 1, 'tep_cfg_select_option(array(\'friendly_with_silent_reporting\', \'friendly\', \'debug\'), $cInfo->configuration_value, \'\', true,', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Send Silent Error Reports To', 'DB_ERROR_EMAIL_ADDRESS', '', 'The email address(es) which will receive error reports if \'Database Error Mode\' is set to \'friendly with silent reporting\'. Addresses remain private and can be seperated by a pipe:<p>mobile@forward.bla|techguy@hostingcomp.bla', 16, 3, 'tep_cfg_cache(', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Email Reporting Limit', 'DB_ERROR_EMAIL_REPORTING_LIMIT', '1800', 'Limit (in seconds) how often a particular database error may <i>maximally</i> be reported. Busy sites will generate many errors (one per pageview) potentially resulting in a flood of email reports. 1800 seconds means half an hour.', 16, 3, 'tep_cfg_cache(', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Debug Mode By Default', 'DB_ERROR_DEFAULT_DEBUG_IPS', '127.0.0.1', 'Use \'debug\' (Database Error Mode) by default for specific ip addresses. This allows developers to see debug information on live sites while visitors see the friendly page.<p>Seperate multiple addresses by a pipe:<p>127.0.0.1|192.168.1.19<p>', 16, 4, 'tep_cfg_cache(', now());
...
INSERT INTO configuration_group VALUES ('16', 'Database Error Mode', 'Configure how database errors are displayed and/or reported', '16', '1');
